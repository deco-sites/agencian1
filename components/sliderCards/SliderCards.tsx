    ...
    <div className="relative w-full overflow-x-clip">
          ...
          <Slider className="carousel carousel-center sm:carousel-end sm:gap-1 row-start-2 row-end-5">
            {images?.map((image, index) => {
              ...
              return (
                <Slider.Item
                  index={index}
                  className="carousel-item flex items-center justify-start md:justify-center pl-6 md:pl-0 gap-6 w-[270px] md:w-1/3 lg:w-1/4"
                >
                  <CardItem
                    image={image}
                    lcp={index === 0 && preload}
      ...
      {(props.icon && props.device === "desktop") && (
        <Image
          ...
          height={125}
          alt="icon"
          class="absolute right-0 -top-40"
        />
      )}
      <div className="absolute hidden md:block -top-28 -left-[215px] h-[469px] w-[469px] rounded-[469.469px] opacity-30 n1-custom-color-gradient-blue blur-[82px]">
      </div>
      <div className="absolute  -bottom-11 -left-28 lg:-bottom-[256px] lg:-left-[80px] h-[291px] md:h-[469px] w-[341px]  lg:w-[341px] md:w-[469px] rounded-[469.464px] opacity-30 n1-custom-color-gradient blur-[82px]">
      </div>
      <div className="absolute -left-12  h-[315px] lg:h-[469px] w-[415px] md:w-[469px] rounded-[469.469px] opacity-30 n1-custom-color-gradient-blue blur-[82px]">
      </div>
      <div className="absolute hidden md:block -right-[198px] h-[469px] w-[469px] rounded-[469.464px] opacity-30 n1-custom-color-gradient blur-[82px]">
      </div>
    </div>
  );
}
