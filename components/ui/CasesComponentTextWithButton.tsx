...
function CasesComponentTextWithButton({ subtitle, text, textButton, hrefButton, activeArrow }:Props ){
    return(
        <>
            ...
            {textButton && (
                <div class={clx(`mobile:mt-[15px] mobile:mb-[20px] mobile:order-3 mobile:justify-start 
