  ...
  return (
    <>
      <div
        class={clx(
          `${
            displayModalForm.value ? "" : "hidden"
          } n1-modal-form fixed top-0 left-0 w-full h-full z-[11] bg-[rgba(11,_18,_39,_0.80)] text-[#ffffff]`,
        )}
      >
        <div class="w-full h-full flex items-start justify-center n1-modal-form__container">
          <div
            class={clx(
              `[box-shadow:0_0px_2px_#fff] mobile:w-[90%] mobile:mt-[100px] notebook:max-w-[55%] notebook:min-w-[40%] 
          ...
          >
            <button
              class={clx(
                `n1-modal-form__close border-[3px] border-secondary flex justify-center items-center 
            ...
            <div>
              {image && (
                <Picture>
                  {image.mobile?.src && image.mobile?.width &&
                    image.mobile?.height && (
                    <Source
                  ...
                  {image?.desktop?.src && image.desktop?.width &&
            ...
            {text?.title && (
              <div
                class="[&_*]:text-32 xl:[&_*]:text-48 [&_*]:font-archimoto-medium [&_*]:font-black"
            ...
            {text?.description && (
              <div
                class="[&_*]:text-18 xl:[&_*]:text-20 [&_*]:font-noto-sans [&_*]:font-normal"
