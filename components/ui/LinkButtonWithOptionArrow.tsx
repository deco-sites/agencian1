...
function LinkButtonWithOptionArrow( {telephone, activeArrow, width}:Props ){
    ...
    return(
        <a 
            ...
            class={clx(`${width ? `w-${width} mobile:my-0 mobile:mx-auto` : 'mobile:w-[130px]' } 
                mobile:relative mobile:py-[7px] mobile:mr-[20px] px-[10px] py-[10px] group flex items-center 
                text-16 uppercase bg-accent n1-btn-header-item--rounded border-none w-[142px] ml-[40px]`)}
        >
            <span class="text-primary text-16 font-archimoto-medium pt-[3px] mobile:mr-[25px] md:mr-[8px] font-black">
                WhatsApp
            </span>
            {activeArrow && (
                <div class="rounded-[50%] p-[5px] bg-[#F8BC33] mobile:absolute mobile:right-[8px]">
