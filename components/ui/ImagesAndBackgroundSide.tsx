    ...
    <>
      <div class="portatil:w-[80%] tablet:w-[80%] tablet:ml-[30px] portatil:ml-[30px]">
        {side?.title && side.title !== '<p><br data-mce-bogus="1"></p>' && (
          <div
            class="[&_*]:text-[#ffffff] [&_*]:text-32 mobile:[&_*]:text-22 font-archimoto-medium font-black mobile:mb-[15px]"
            dangerouslySetInnerHTML={{ __html: side.title }}
          >
          </div>
        )}
        {side?.description &&
          side.description !== '<p><br data-mce-bogus="1"></p>' && (
          <div
            class="[&_*]:text-[#ffffff] [&_*]:text-14 font-noto-sans"
