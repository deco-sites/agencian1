...
export default function Dots({ images }: Props) {
  return (
    <>
      ...
      />
      <ul class="mobile:relative mobile:top-0 carousel justify-center
        ...
        {images?.map((_, index) => (
          <li class="carousel-item">
            <Slider.Dot index={index}>
              <div class="">
                <span class="flex item-center w-[170px] h-[51px] justify-center rounded-[90px]  bg-[#3CCBDA] group-disabled:bg-[#0B1227] py-3 px-8 ">
                  {index + 1}
                </span>
              </div>
            </Slider.Dot>
