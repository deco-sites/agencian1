...
function TextWithImageAnimation ( props: SectionProps<ReturnType<typeof loader>> ){
    const { 
        settingsText, 
        textImage, 
        allImage, 
                ...
                <div 
                    ...
                    <div class="flex items-center justify-center">
                        <div 
                            ...
                            >
                            {allImage && allImage.length > 0 && allImage.map(({alt, href, image, width, height, orderImage})=>{
                                if(image){
                                    return(
                                        <a href={`${href ? href : "javascript:void(0)"}`} style={{ pointerEvents : `${href ? 'all' : 'none'}` }}
                                            class={`
                                                ${orderImage === 1 ? 'mobile:col-[2] col-[3] row-[1] flex justify-center z-10' 
                                                : orderImage === 2 ? 'mobile:col-[3] mobile:mt-[57px] mobile:mb-[55px] row-[2] col-[5] mt-[70px] mb-[60px] flex justify-end z-10'
                                                : orderImage === 3 ? 'mobile:col-[3] row-[3] col-[4_/_2_span] -translate-x-[50px] flex justify-start z-10'
                                                : orderImage === 4 ? 'mobile:col-[1] row-[3] col-[1_/_2_span] translate-x-[50px] flex justify-end z-10'
                                                : orderImage === 5 ? 'mobile:mt-[57px] mobile:mb-[55px] row-[2] col-[1] mt-[70px] mb-[60px] z-10'
                                                : ""
                                                }                                
                                            `}> 
