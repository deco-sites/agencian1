            ...
            <div class="flex flex-col items-start">
              <div class="flex flex-col items-start justify-start">
                {settingsText && settingsText?.subtitle && (
                  <div
                    class={clx(`mobile:px-[20px] n1-textwithimageanimation__subtitle mobile:[&_*]:!text-24 inline-block font-archimoto-medium text-48 font-black
                    ${settingsText?.addBar ? 'is-bar-custom' : settingsText?.addKeysInWords ? 'is-keys-custom' : ""}`)}
