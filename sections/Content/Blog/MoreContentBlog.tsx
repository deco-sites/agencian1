...
function MoreContentBlog(
  { title, posts, disableAside, layout, showTag = true }: Props,
) {
  return (
    <>
      <section
                      ...
                      >
                        <div class={`n1-blog relative`}>
                          {(post?.categories?.length > 0 && showTag) && (
                            <div class="left-3 top-3 absolute w-fit font-semibold text-14 text-[#0C1F59] py-[6px] px-[14px] rounded-[30px] bg-[#3CCBDA]">
                          ...
                          <div>
                            ...
                            {post?.title && (
                              <div
                                class={clx(
                                  `n1-moreContentBlog__title mb-[10px]`,
                                )}
                              >
                                {
                                  /* <BlogTitle
                                ...
                                <a href={`/nosso-blog/post?slug=${post?.slug}`}>
                                  {title && (
                                    <div
                                      class={clx(
                                        `text-24 n1-blog__title font-archimoto-medium font-black`,
                                      )}
