    ...
    return(
        <>
            <div class="text-[#ffffff]">
                ...
                <div class="md:n1-container md:px-[120px] relative z-1 flex flex-col justify-center items-center"
                    style={{
                        height : `${validBackground ? backgroundImage.height + 'px' : 'initial'}`,
                        zIndex : `${validBackground ? 0 : 'initial'}`
                    }}>
                    <div class="flex justify-center items-center">
                        {icon && (
                            <Picture >
                                    {icon?.desktop && icon.desktop?.src && icon.desktop?.width && icon?.desktop?.height && (
                                        <Source
                                    ...
                                    {icon?.mobile && icon.mobile?.src && icon.mobile?.width && icon?.mobile?.height && (
                                        <Source
                                            src={icon.mobile.src}
