...
function PopupLgpt( { image, text, textBtn } : Props ){
    ...
    return(
        <>
            <div class={`hidden n1-popup fixed bottom-[20px] w-full mobile:left-[10px] mobile:w-[95%] mobile:mx-[auto]`}>                
                <div 
                    class={clx(`flex items-center lg:max-w-[1034px] lg:my-0 lg:mx-auto lg:py-[18px] lg:px-[60px]
                    ...
                    { text && (
                        <div
                            class={clx(`[&_*]:text-14 mobile:[&_*]:text-12 [&_*]:font-archimoto-medium text-[#ffffff] lg:ml-[20px] lg:mr-[50px]
