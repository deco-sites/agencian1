        ...
        <>
            ...
            >
                ...
                <div>
                    ...
                    { settingsInfo?.text && (
                        <span class="text-[#ffffff] flex font-noto-sans-thin md:text-14 font-normal mt-[16px] mobile:mb-[32px] md:mb-[59px]"> { settingsInfo?.text } </span>
                    ) }
                ...
                <div class=" md:n1-container md:px-[120px] z-10 md:mb-[40px] relative">
                    ...
                    <div class="mobile:my-[24px] mt-[120px] mb-[43px] text-[#ffffff] flex items-center justify-between">
                        <div class="mobile:px-[20px]">
                            ...
                            {text && (
                                <span class="md:flex font-noto-sans-thin block mt-[11px] text-20 leading-[26px]"
                                    dangerouslySetInnerHTML={{
                                        __html: text,
                                    }}
                                >                                
