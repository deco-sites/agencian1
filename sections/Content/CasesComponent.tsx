        ...
        <>
            <div class="mobile:px-[20px] md:mt-[120px] relative z-1 overflow-hidden">
                ...
                <div class=" flex flex-col flex-wrap lg:grid lg:grid-rows-[repeat(2,_auto)] xl:n1-container md:px-[120px] py-[0]">
                    ...
                    <CasesComponentTextWithButton subtitle={subtitle} text={text} textButton={textButton} hrefButton={hrefButton} activeArrow={activeArrow} />

                    {device === 'desktop' && (<CasesComponentDesktop settingsImage={settingsImage} />)}

                    {device === 'mobile' && (<CasesComponentMobile settingsImage={settingsImage} />)}
