        ...
        <>
            <div class="relative">
                ...
                <div class="md:n1-container md:px-[120px] md:py-[80px] mobile:pb-[80px] relative z-10 mobile:px-[20px]">
                    <div>
                        {text && (
                            <div class="mobile:[&_*]:text-24 mobile:max-w-[95%] md:[&_*]:text-48 font-black font-archimoto-medium text-[#ffffff] mb-[30px]"
                                dangerouslySetInnerHTML={{ __html: text }}>
                            </div>
                        )}
                        
                        {link && (
                            <div class={`${!link?.activeArrowInButton ? 'n1-link__no-arrow' : ""}`}>
