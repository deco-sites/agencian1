    ...
    return(
        <>
            <div class="n1-mosaic md:mt-[100px]">
                <div class="flex flex-col text-[#ffffff] md:n1-container md:px-[120px] gap-[22px] pb-[10px] mobile:px-[20px]"
                    onMouseLeave={handleMouserHover}>

                    {/* ITEMS TOP - INITIAL */}
                    
                    <div class={clx(`n1-mosaic is-top grid grid-cols-[repeat(3,_1fr)] grid-rows-1 text-[#ffffff] 
                        ...
                        {imageTop && imageTop?.map(({ desktop, mobile, text, name })=>{
                            return(
                                <>
                                    <div 
                                        class={clx(`n1-mosaic__container top is-${text && text?.bgColor === 'base-50' ? 'white' : 'primary' } 
