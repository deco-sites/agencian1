...
function TextWithImageCustom(
  ...
  return (
    <>
      ...
      >
        {textLarge && (
          <h1 class={clx(`n1-text-width-custom__title mobile:text-[44px] mobile:leading-[56px] mobile:w-[80%] 
            text-[90px] md:max-w-[60%] font-archimoto-medium font-black`)}>
            {textLarge}
          </h1>
        )}
        {image && width && height && (
          <img
            src={image}
            class={clx(`mobile:w-[30%] mobile:-rotate-[70deg] mobile:[bottom:initial] mobile:top-[130px] mobile:[left:initial] mobile:right-[20px]
        ...
        {textCircleLg && textCircleSm && (
          <div class="mobile:mt-[60px] relative group">
            <div 
              class={clx(`group-hover:bg-transparent duration-500 group-hover:border-[#ffffff] mobile:w-[222px] border-2 border-transparent 
            ...
            <div 
              class={clx(`mobile:w-[100px] mobile:h-[100px] mobile:bottom-[30px] mobile:right-[40px] group-hover:visible duration-500 group-hover:opacity-100 
