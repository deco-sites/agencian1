...
function TitleTextIconsAndImage( props: SectionProps<ReturnType<typeof loader>> ){
    const { 
        title, 
        description, 
        iconWidthText, 
                            ...
                            <div class="">
                                <div class="md:ml-[20px]">
                                    ...
                                    { description && description !== '<p><br data-mce-bogus="1"></p>' && (
                                        <div 
                                            class={clx(`[&_*]:font-noto-sans [&_*]:text-16 [&_*]:mobile:text-14 
                                                md:mt-[43px] md:mb-[50px] mobile:mt-[20px] mobile:mb-[30px]`)}
                                            style={{ 
                                                maxWidth : device === 'desktop' && maxWidthText ? maxWidthText + '%' : ''
                                             }}
                                ...
                                <ul class={clx(`${gridActive && gridColCustom ? 'grid ' + GRIDCOLCUSTOM[gridColCustom] : ''} 
                                    items-center flex flex-col xl:flex-wrap xl:flex-row`)}>
                                    {iconWidthText && iconWidthText?.map(( { alt, src, width, height } )=>{
                                        return(
                                            <>
                                                { alt && src && width && height && (
                                                    <li class={clx(`w-full xl:w-auto justify-start rounded-[20px] 
                                                        ...
                                                        />                                                        
                                                        <span 
                                                            class={`text-16 ${fontIconText ? FONTICONTEXT[fontIconText] : 'font-noto-sans'} 
                                                                ${activeBold ? "font-black" : "font-normal" } ml-[20px]`}> 
                                                            {alt} 
                                                        </span>
                                                    </li>
                                                )}
